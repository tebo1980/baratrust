    ...
    <div className="w-full max-w-6xl mx-auto space-y-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-indigo-500/20 pb-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 rounded-full text-xs font-bold tracking-widest uppercase shadow-[0_0_10px_rgba(16,185,129,0.15)] flex items-center gap-2">
        ...
        <div className="flex items-center gap-3">
          <button className="px-4 py-2 bg-[#0A1019] border border-amber-500/30 text-amber-400 rounded-lg text-sm font-semibold hover:bg-amber-500/10 transition-colors shadow-lg flex items-center gap-2">
          ...
          <button className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white border border-indigo-500 rounded-lg text-sm font-semibold transition-colors shadow-[0_0_15px_rgba(79,70,229,0.4)] flex items-center gap-2">
      ...
      <section className="bg-[#0B0F19] border border-indigo-500/20 rounded-xl shadow-lg overflow-hidden">
        <div className="p-6 border-b border-indigo-500/20 flex items-center justify-between">
           ...
           <span className="text-xs text-slate-400 font-medium bg-[#0A1019] px-3 py-1 rounded-full border border-slate-800">3 Prospects Scheduled</span>
        </div>
