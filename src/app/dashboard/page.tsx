    ...
    <div className="min-h-screen bg-zinc-950 font-sans text-zinc-100 selection:bg-amber-500/30">
      ...
      <main className="max-w-7xl mx-auto p-10 mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* FETCH / PIONEER AGENT */}
          <Link href="/pioneer">
            <motion.div whileHover={{ y: -5 }} className="group relative bg-zinc-900 rounded-2xl p-8 border border-zinc-800 overflow-hidden hover:border-amber-500/50 hover:shadow-[0_0_30px_rgba(245,158,11,0.1)] transition-all h-full flex flex-col">
              <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-amber-500/10 to-transparent blur-3xl rounded-full group-hover:from-amber-500/20 transition-colors" />

              <div className="flex justify-between items-start mb-8 relative">
                <div className="w-14 h-14 bg-zinc-950 border border-zinc-800 rounded-xl flex items-center justify-center text-amber-500 group-hover:scale-110 transition-transform">
              ...
              <h2 className="text-2xl font-bold text-zinc-100 mb-2">Fetch Autopilot</h2>
              <p className="text-zinc-400 text-sm leading-relaxed mb-8 flex-1">
                Access the Live Memory Bank. View the autonomous scouting matrix, manage harvested contractor leads, and monitor regional sweeps in real-time.
              </p>

              <div className="flex items-center text-amber-500 font-mono text-xs uppercase tracking-widest font-bold group-hover:gap-3 transition-all gap-2">
                Launch Pioneer <ArrowRight className="w-4 h-4" />
              </div>
            </motion.div>
          </Link>

          {/* BRIX AGENT */}
          <Link href="/dashboard/brix">
            <motion.div whileHover={{ y: -5 }} className="group relative bg-zinc-900 rounded-2xl p-8 border border-zinc-800 overflow-hidden hover:border-blue-500/50 hover:shadow-[0_0_30px_rgba(59,130,246,0.1)] transition-all h-full flex flex-col">
              <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-blue-500/10 to-transparent blur-3xl rounded-full group-hover:from-blue-500/20 transition-colors" />

              <div className="flex justify-between items-start mb-8 relative">
                <div className="w-14 h-14 bg-zinc-950 border border-zinc-800 rounded-xl flex items-center justify-center text-blue-500 group-hover:scale-110 transition-transform">
              ...
              <h2 className="text-2xl font-bold text-zinc-100 mb-2">Brix Configuration</h2>
              <p className="text-zinc-400 text-sm leading-relaxed mb-8 flex-1">
                Manage AI service agents. Adjust core prompt matrices, review interaction logs, and configure active service deployment across contractor sites.
              </p>

              <div className="flex items-center text-blue-500 font-mono text-xs uppercase tracking-widest font-bold group-hover:gap-3 transition-all gap-2">
                Configure Brix <ArrowRight className="w-4 h-4" />
              </div>
            </motion.div>
          </Link>
