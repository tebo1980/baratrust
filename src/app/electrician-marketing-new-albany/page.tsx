  ...
  return (
    <SeoTradePage
      ...
      features={[
        ...
        { icon: '\uD83E\uDD16', title: '10 AI Agents', text: 'A full AI staff handling leads, reviews, follow-ups, social media, invoices, and appointments — all running while you\'re on the job site.' },
      ...
      stats={[
        ...
        { num: '10', label: 'AI agents working for your electrical business' },
